...
(function() {
  ...
  function cb(m) {
    if (!db) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((m.creditHref = ga("iuuqr;..b`ow`rkr/bnl.")), (m.creditText = ga("B`ow`rKR/bnl")))
        : ((s = m.updateOption("creditText")), (q = m.updateOption("creditHref")));
      if (m.creditHref && m.creditText) {
        ...
        m._creditLink && m.creditHref && m.creditText
          ? (m._creditLink.parentElement || m._canvasJSContainer.appendChild(m._creditLink),
            (m._creditLink.style.top = m.height - 14 + "px"))
          : m._creditLink.parentElement && m._canvasJSContainer.removeChild(m._creditLink);
      }
    }
  }
  function ta(m, s) {
  ...
  var W = {},
    ...
    za = {
      colorSet1: "#4F81BC #F36969 #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(
        " "
      ),
      ...
      return function(S, C, I) {
        ...
        return (I = C.replace(m, function(c) {
          switch (c) {
            ...
            case "zzz":
              return (
                (0 < b ? "-" : "+") + ha(Math.floor(Math.abs(b) / 60), 2) + ha(Math.abs(b) % 60, 2)
              );
            default:
      ...
      for (P = S = X = R = C = 0; 0 < I.length; )
        if (((s = I.pop()), "#" === s || "0" === s))
          if ((C++, C === J)) {
            ...
            for (; 0 < Y.length; )
              (q = Y.pop() + q), P++, 0 === P % S && (X === U && 0 < Y.length) && (q = x + q);
          } else
            0 < z.length ? ((q = z.pop() + q), R++, P++) : "0" === s && ((q = "0" + q), R++, P++),
              0 === P % S && (X === U && 0 < z.length) && (q = x + q);
        else
          ("E" !== s[0] && "e" !== s[0]) || "0" !== s[s.length - 1] || !/[eE][+-]*[0]+/.test(s)
            ? "," === s
              ...
              : (q =
                  ...
                  (('"' === s[0] && '"' === s[s.length - 1]) ||
                    ...
                    : s + q)
            : ((s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", "")),
    ...
    Oa = function(m) {
      ...
      m.offsetX || 0 === m.offsetX
        ...
        : m.layerX || 0 == m.layerX
          ...
          : ((s = m.pageX - m.target.offsetLeft), (q = m.pageY - m.target.offsetTop));
      return { x: s, y: q };
    },
    Xa = !0,
  ...
  Y.prototype.get = function(m) {
    ...
    if (s.hasOwnProperty(m) || (s.publicProperties && s.publicProperties.hasOwnProperty(m)))
      return this[m];
    window.console &&
  ...
  Y.prototype.set = function(m, s, q) {
    ...
    if ("options" === m) this.createUserOptions(s);
      ...
      this.options._isPlaceholder && this.createUserOptions(), (this.options[m] = s);
    else {
      window.console &&
        (v.publicProperties &&
        v.publicProperties.hasOwnProperty(m) &&
  ...
  ka.prototype._initialize = function() {
    y(this.padding) || "object" !== typeof this.padding
      ...
      : ((this.topPadding = y(this.padding.top) ? 0 : Number(this.padding.top) | 0),
        (this.rightPadding = y(this.padding.right) ? 0 : Number(this.padding.right) | 0),
        (this.bottomPadding = y(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0),
        (this.leftPadding = y(this.padding.left) ? 0 : Number(this.padding.left) | 0));
  };
  ...
  Ha.prototype.render = function() {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth = v.width - 4 - R * ("center" === this.horizontalAlign ? 2 : 1)),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ...
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = v.width - 4), (F = 0.5 * v.height - 4)));
      var I;
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ? ((x = v.y1 + 2), (C = "top"))
            : "bottom" === this.verticalAlign && ((x = v.y2 - 2 - I.height), (C = "bottom")),
          "left" === this.horizontalAlign
            ? (q = v.x1 + 2)
            : "center" === this.horizontalAlign
              ? (q = v.x1 + v.width / 2 - I.width / 2)
              : "right" === this.horizontalAlign && (q = v.x2 - 2 - I.width - R),
  ...
  Ka.Chart = (function() {
    ...
    function x(a, f) {
      for (var b = [], c, e = 0; e < a.length; e++)
        if (0 == e) b.push(a[0]);
          ...
          c =
            (Math.abs((a[h].x - a[g].x) / (0 === a[h].x - a[l].x ? 0.01 : a[h].x - a[l].x)) *
              (f - 1)) /
              2 +
            1;
          var t = (a[h].x - a[g].x) / c;
          ...
          h = l === a.length - 1 ? l : l + 1;
          c =
            (Math.abs((a[h].x - a[g].x) / (0 === a[l].x - a[g].x ? 0.01 : a[l].x - a[g].x)) *
              (f - 1)) /
              2 +
            1;
          t = (a[h].x - a[g].x) / c;
    ...
    function z(a, f, b, c, e, g, h, l, t, k) {
      ...
      a.beginPath();
      t && 0 < h.thickness
        ? (a.moveTo(c - r, b), a.lineTo(c - r, e), a.moveTo(f + r, b), a.lineTo(f + r, e))
        : 0 < h.thickness &&
          (a.moveTo(f, b + r), a.lineTo(c, b + r), a.moveTo(f, e - r), a.lineTo(c, e - r));
      a.stroke();
      a.restore();
    }
      ...
      "axisX" === e
        ...
        : "left" === g || "bottom" === g
          ? ((this.optionsName = "axisY"),
            y(this.chart.sessionVariables.axisY[c]) && (this.chart.sessionVariables.axisY[c] = {}),
      ...
      if (this.options.data) {
        for (var b = 0; b < this.options.data.length; b++)
          if (
            ...
            "error" === c.type &&
              ((c.linkedDataSeriesIndex = y(this.options.data[b].linkedDataSeriesIndex)
                ? b - 1
            ...
            "normal" === e
              ...
              : "xySwapped" === e
                ...
                : "none" === e
                  ? "normal" === this.plotInfo.axisPlacement
                    ? (g =
                        'You cannot combine "' + c.type + '" with line, area, column or bar chart')
                    : "xySwapped" === this.plotInfo.axisPlacement
                      ? (g = 'You cannot combine "' + c.type + '" with bar chart')
                      : null === this.plotInfo.axisPlacement &&
        ...
        for (b = 0; b < this.data.length; b++) {
          ...
          "error" === this.data[b].type &&
            ((this.data[b].axisPlacement = this.plotInfo.axisPlacement = f || "normal"),
    ...
    q.prototype.render = function(a) {
          ...
          if (!this.data[a].axisYType || "primary" === this.data[a].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              this.data[a].axisY = this.axisY[
                0 <= this.data[a].axisYIndex && this.data[a].axisYIndex < this.axisY.length
              ...
              this.axisY.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push(
                      (this.axisY[0] = new C(this, "axisY", this.options.axisY, 0, "axisY", "left"))
                    )
                  : "xySwapped" === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisY[0] = new C(
          ...
          if ("secondary" === this.data[a].axisYType)
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              ...
              this.data[a].axisY = this.axisY2[
                0 <= this.data[a].axisYIndex && this.data[a].axisYIndex < this.axisY2.length
                  ? this.data[a].axisYIndex
                  : 0
              ];
              this.axisY2[
          ...
          if (!this.data[a].axisXType || "primary" === this.data[a].axisXType)
            if (this.options.axisX && 0 < this.options.axisX.length) {
              ...
              this.data[a].axisX = this.axisX[
                0 <= this.data[a].axisXIndex && this.data[a].axisXIndex < this.axisX.length
              ...
              this.axisX.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ...
                  : "xySwapped" === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisX[0] = new C(this, "axisX", this.options.axisX, 0, "axisX", "left"))
                    )),
          ...
          if ("secondary" === this.data[a].axisXType)
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              ...
              this.data[a].axisX = this.axisX2[
                0 <= this.data[a].axisXIndex && this.data[a].axisXIndex < this.axisX2.length
                  ? this.data[a].axisXIndex
                  : 0
              ];
              this.axisX2[
      ...
      this.options.title &&
        ...
        this.title.dockInsidePlotArea ? f.push(this.title) : this.title.render());
                                            ...
                                            : "doughnut" === t.type
                                              ...
                                              : "funnel" === t.type
                                                ...
                                                : "pyramid" === t.type
                                                  ? (k = this.renderFunnel(t))
                                                  : "candlestick" === t.type
                                                    ? (k = this.renderCandlestick(t))
                                                    : "ohlc" === t.type
                                                      ? (k = this.renderCandlestick(t))
                                                      : "rangeColumn" === t.type
                                                        ? (k = this.renderRangeColumn(t))
                                                        : "error" === t.type
                                                          ? (k = this.renderError(t))
                                                          : "rangeBar" === t.type
                                                            ? (k = this.renderRangeBar(t))
                                                            : "rangeArea" === t.type
                                                              ? (k = this.renderRangeArea(t))
                                                              : "rangeSplineArea" === t.type
                                                                ? (k = this.renderRangeSplineArea(
                                                                    t
                                                                  ))
                                                                : "waterfall" === t.type
                                                                  ? (k = this.renderWaterfall(t))
                                                                  : "boxAndWhisker" === t.type &&
                ...
                (k = c[b]),
                  1 > a && "undefined" !== typeof k.startTimePercent
                    ? a >= k.startTimePercent &&
                      k.animationCallback(
                        k.easingFunction(a - k.startTimePercent, 0, 1, 1 - k.startTimePercent),
                        k
                      )
          ...
          for (t = 0; t < l.dataPoints.length; t++) {
            ...
            if (c < n && !k) null !== e && (p = c);
              ...
              null === e
                ...
                : (e < f.viewPortMin && "number" === typeof e && (f.viewPortMin = e),
                  e > f.viewPortMax && "number" === typeof e && (f.viewPortMax = e));
            }
          }
        ...
        for (
          ...
          a.axisY.scaleBreaks &&
            ...
            (f.dataPointYPositiveSums
              ? (f.dataPointYPositiveSums.push.apply(f.dataPointYPositiveSums, h),
                f.dataPointYNegativeSums.push.apply(f.dataPointYPositiveSums, l))
              : ((f.dataPointYPositiveSums = h), (f.dataPointYNegativeSums = l)));
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        a.axisY.logarithmic
          ? ((f.max = y(f.viewPortMax)
              ...
              : Math.max(f.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05))),
    ...
    q.prototype._processMultiYPlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, h, l = !1, t = 0;
            ...
            0 < r &&
              (a.axisX.logarithmic
                ...
                : ((w = c - k.dataPoints[r - 1].x),
                  ...
                  b.minDiff > w && 0 !== w && (b.minDiff = w)),
              e &&
                (null !== e[0] && k.dataPoints[r - 1].y && null !== k.dataPoints[r - 1].y[0]) &&
                (a.axisY.logarithmic
        ...
        for (
          ...
          for (t = 0; t < l.dataPoints.length; t++)
            ...
            !0 === l.dataPoints[t].isCumulativeSum
              ? ((l.dataPointEOs[t].cumulativeSumYStartValue = 0),
                ...
                (l.dataPoints[t].y = 0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum))
              : "undefined" !== typeof l.dataPoints[t].isIntermediateSum &&
                ...
                ? ((l.dataPointEOs[t].cumulativeSumYStartValue = p),
                  ...
                  (c = 0))
                : ((e = "number" !== typeof l.dataPoints[t].y ? 0 : l.dataPoints[t].y),
          ...
          for (t = 0; t < l.dataPoints.length; t++)
            if (
              ...
              c < b.min && (b.min = c),
              c > b.max && (b.max = c),
              l.dataPointEOs[t].cumulativeSum < f.min && (f.min = l.dataPointEOs[t].cumulativeSum),
              l.dataPointEOs[t].cumulativeSum > f.max && (f.max = l.dataPointEOs[t].cumulativeSum),
              0 < t &&
                (a.axisX.logarithmic
                ...
                null !== e &&
                  null !== l.dataPoints[t - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e = l.dataPointEOs[t].cumulativeSum / l.dataPointEOs[t - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
    ...
    q.prototype.calculateAutoBreaks = function() {
      ...
      function b(a) {
        if (
          ...
          for (
            var c = a.axisX.dataInfo, b = c.min, f = c.max, g = c._dataRanges, k, h = 0, n = 0;
            ...
            if (!(4 > l.dataPoints.length))
              for (h = 0; h < l.dataPoints.length; h++)
                (k =
                  ...
                  100),
                  (c = l.dataPoints[h].x.getTime ? l.dataPoints[h].x.getTime() : l.dataPoints[h].x),
                  (k = Math.floor((c - b) / k)),
                  c < g[k].min && (g[k].min = c),
                  c > g[k].max && (g[k].max = c);
          }
      ...
      if (g) {
        ...
        for (h = 0; h < this._axes.length; h++)
          if (this._axes[h].dataInfo._dataRanges) {
            ...
            if (this._axes[h].scaleBreaks.customBreaks)
              for (l = 0; l < this._axes[h].scaleBreaks.customBreaks.length; l++)
                for (c = 0; c < g.length; c++)
                  if (
                    (this._axes[h].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[h].scaleBreaks.customBreaks[l].endValue) ||
                    (this._axes[h].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[h].scaleBreaks.customBreaks[l].endValue) ||
                    (g[c].start <= this._axes[h].scaleBreaks.customBreaks[l].startValue &&
                      this._axes[h].scaleBreaks.customBreaks[l].startValue <= g[c].end) ||
                    (g[c].start <= this._axes[h].scaleBreaks.customBreaks[l].endValue &&
                      this._axes[h].scaleBreaks.customBreaks[l].endValue <= g[c].end)
                  )
                    g.splice(c, 1), c--;
            g.sort(function(a, c) {
            ...
            for (
              l = 0;
              l < Math.min(g.length, this._axes[h].scaleBreaks.maxNumberOfAutoBreaks);
              l++
            )
              (c = a(
                g[l].start,
    ...
    q.prototype.getDataPointAtXY = function(a, f, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((e = ja("markerSize", c[b].dataPoint, c[b].dataSeries) || 8), c[b].distance <= e / 2)
          ) {
            f = !0;
            break;
          }
      ...
      q.capturedEventParam &&
        ...
        c.hasOwnProperty(b) &&
          ("mouseup" !== b || c.chart.overlaidCanvas.releaseCapture
            ? (a.target !== c.chart.overlaidCanvas && v) || c[b].call(c.context, f.x, f.y)
    ...
    q.prototype._plotAreaMouseMove = function(a, f) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled || this.zoomEnabled)
          ? this.toolTip.hide()
          : this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, f);
        if (
    ...
    q.prototype.validateRegion = function(a, f, b, c, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[p].type && g) || ("axisY" === this._axes[p].type && h)) &&
          k.push(this._axes[p]);
    ...
    q.prototype.renderIndexLabels = function(a) {
        ...
        if (null !== H && "" !== H) {
            ...
            "inside" !== u
              ? ((e = b.y1),
                ...
                0 < q
                  ? ((n = k.point.y - t - h - c),
                    n < e &&
                      ((n = "auto" === u ? Math.max(k.point.y, e) + h + c : e + h + c),
                      (x = n + t > k.point.y)))
                  : ((n = k.point.y + h + c),
                    n > g - t - h - c &&
                      ((n = "auto" === u ? Math.min(k.point.y, g) - t - h - c : g - t - h - c),
                      (x = n < k.point.y))))
              : ((e = Math.max(k.bounds.y1, b.y1)),
                ...
                (c =
                  0 <= r.indexOf("range") || "error" === r
                    ...
                    : (Math.max(k.bounds.y1, b.y1) + Math.min(k.bounds.y2, b.y2)) / 2),
                0 < q
              ...
              "inside" !== u
                ? ((h = b.x1),
                  ...
                  0 > q
                    ? ((p = k.point.x - l - e - c),
                      p < h &&
                        ((p = "auto" === u ? Math.max(k.point.x, h) + e + c : h + e + c),
                        (x = p + l > k.point.x)))
                    : ((p = k.point.x + e + c),
                      p > g - l - e - c &&
                        ((p = "auto" === u ? Math.min(k.point.x, g) - l - e - c : g - l - e - c),
                        (x = p < k.point.x))))
                : ((h = Math.max(k.bounds.x1, b.x1)),
                  ...
                  (c =
                    0 <= r.indexOf("range") || "error" === r
                      ...
                      : (Math.max(k.bounds.x1, b.x1) + Math.min(k.bounds.x2, b.x2)) / 2),
                  (p = 0 > q ? Math.max(k.point.x, c) - l / 2 : Math.min(k.point.x, c) - l / 2),
                  (p = Math.max(p, h)));
          "vertical" === Q && (n += t);
          d.x = p;
          d.y = n;
          ...
          D &&
            ...
            0 <= r.indexOf("bar") || ("error" === r && k.axisSwapped)
              ? f.lineTo(p + (0 < k.direction ? 0 : l), n + ("horizontal" === Q ? t : -t) / 2)
              : 0 <= r.indexOf("column") || ("error" === r && !k.axisSwapped)
                ? f.lineTo(
                    p + l / 2,
                    n + ((0 < k.direction ? t : -t) + ("horizontal" === Q ? t : -t)) / 2
                  )
                : f.lineTo(
                    p + l / 2,
                    n + ((n < k.point.y ? t : -t) + ("horizontal" === Q ? t : -t)) / 2
                  ),
            f.stroke());
        }
      }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (k = this._indexLabels[a]),
          (d = ja("indexLabelBackgroundColor", k.dataPoint, k.dataSeries)),
          (k.dataSeries.indexLabelBackgroundColor = y(d) ? (v ? "transparent" : null) : d);
      return f;
    };
            ...
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ...
                !(
                  ...
                  (Q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q))
                ))
              )
                if ("number" !== typeof r[u].y)
                  0 < u && !(k.connectNullData || q || D) && (b.stroke(), v && c.stroke()),
                    (q = !0);
                else {
                  ...
                  D || q
                    ? (!D && k.connectNullData
                        ? (b.setLineDash &&
                          ...
                          b.lineTo(Q, H),
                          v && c.lineTo(Q, H))
                        : (b.beginPath(), b.moveTo(Q, H), v && (c.beginPath(), c.moveTo(Q, H))),
                      (q = D = !1))
                    : (b.lineTo(Q, H),
                      v && c.lineTo(Q, H),
                      0 == u % 500 &&
                  ...
                  h = { x: Q, y: H };
                  u < r.length - 1 &&
                    (m !== (r[u].lineColor || w) || p !== (r[u].lineDashType || k.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(Q, H),
                    (m = r[u].lineColor || w),
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ? ((p = r[u].lineDashType), b.setLineDash(F(p, k.lineThickness)))
          ...
          for (var b = 0; b < a.length - 3; b += 3)
            if (
              ...
              c.stroke(),
                ...
                v && (e.stroke(), e.beginPath(), e.moveTo(a[b + 3].x, a[b + 3].y));
          c.stroke();
          v && e.stroke();
        }
      }
            ...
            for (Q = !1, D = 0; D < r.length; D++)
              if (
                ...
                !(
                  ...
                  (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !Q))
                ))
              )
                if ("number" !== typeof r[D].y)
                  0 < D &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        (0 < H.length &&
                          (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) &&
                        ((H[H.length - 1].newLineDashArray = n), (p = k.nullDataLineDashType))
                      : (f(H), (H = []))),
                    (Q = !0);
                else {
                  ...
                  H[H.length] = { x: u, y: Q };
                  D < r.length - 1 &&
                    (m !== (r[D].lineColor || w) || p !== (r[D].lineDashType || k.lineDashType)) &&
                    ((m = r[D].lineColor || w),
                    (H[H.length - 1].newStrokeStyle = m),
                    c.setLineDash &&
                      (r[D].lineDashType
                        ? ((p = r[D].lineDashType),
                          (H[H.length - 1].newLineDashArray = F(p, k.lineThickness)))
                        : ((p = k.lineDashType), (H[H.length - 1].newLineDashArray = d))));
    ...
    q.prototype.renderStackedColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > r &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, r));
        !this.dataPointMaxWidth &&
          (this.dataPointMinWidth && r < k) &&
          (r = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        d < k && (d = k);
        d > r && (d = r);
        b.save();
        v && this._eventManager.ghostCtx.save();
              ...
              if (
                ...
                if (
                  ...
                  (A = "undefined" !== typeof h[c] ? h[c] : 0),
                    (y = p + A),
                    (p = n + A),
                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.y2 - y) && (y = e.y2),
                    (h[c] = A + (y - p));
                c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
                X(
                  b,
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (l[c] = u[k].y + (l[c] ? l[c] : 0)),
                    0 < l[c] &&
                      ((B = g[c] ? g[c] : n), (g[c] = r = a.axisY.convertValueToPixel(l[c])));
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= u[k].y
              ...
              if (
                ...
                if (
                  ...
                  (A = h[c] ? h[c] : 0),
                    (s = r - A),
                    (r = n - A),
                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - s) && (s = e.x1),
                    (h[c] = A + (r - s));
                c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
          ...
          if (0 < m.length) {
            ...
            for (var ca = !0; D < m.length; D++)
              if (
                ...
                !(
                  q < a.axisX.dataInfo.viewPortMin ||
                  (q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !ca))
                ))
              )
                  ...
                  f || ca
                    ? (!f && w.connectNullData
                        ...
                        : (g.beginPath(),
                          ...
                          (A = { x: u, y: s })),
                      (ca = f = !1))
                    : (g.lineTo(u, s), v && h.lineTo(u, s), 0 == D % 250 && c());
                  p = { x: u, y: s };
                  D < m.length - 1 &&
                    (L !== (m[D].lineColor || z) || b !== (m[D].lineDashType || w.lineDashType)) &&
                    (c(),
                    (L = m[D].lineColor || z),
                    (g.strokeStyle = L),
                    g.setLineDash &&
                      (m[D].lineDashType
                        ? ((b = m[D].lineDashType), g.setLineDash(F(b, w.lineThickness)))
            ...
            for (m = !1; d < n.length; d++)
              if (
                ...
                !(
                  ...
                  (w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m))
                ))
              )
                if ("number" !== typeof n[d].y)
                  0 < d &&
                    ...
                    (p.connectNullData
                      ? c.setLineDash &&
                        (0 < q.length &&
                          (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) &&
                        ((q[q.length - 1].newLineDashArray = la), (z = p.nullDataLineDashType))
                      : (f(), (q = []))),
                    (m = !0);
                else {
                  ...
                  q[q.length] = { x: w, y: m };
                  d < n.length - 1 &&
                    (A !== (n[d].lineColor || B) || z !== (n[d].lineDashType || p.lineDashType)) &&
                    ((A = n[d].lineColor || B),
                    (q[q.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (n[d].lineDashType
                        ? ((z = n[d].lineDashType),
                          (q[q.length - 1].newLineDashArray = F(z, p.lineThickness)))
                        : ((z = p.lineDashType), (q[q.length - 1].newLineDashArray = L))));
          ...
          if (0 < m.length) {
            ...
            for (; D < m.length; D++)
              if (
                ...
                !(
                  q < a.axisX.dataInfo.viewPortMin ||
                  (q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !b))
                ))
              ) {
                var aa = s;
                "number" !== typeof m[D].y
                  ...
                  : ((u = a.axisX.convertValueToPixel(q)),
                    ...
                    D < m.length - 1 &&
                      ...
                      g.setLineDash &&
                        (m[D].lineDashType
                          ? ((K = m[D].lineDashType), g.setLineDash(F(K, w.lineThickness)))
        ...
        for (y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          if (0 < k.length) {
            ...
            for (var ca = !0, p = 0; p < k.length; p++) {
              w = k[p];
              var aa = null,
                aa = 0 <= A.dataPointIndexes[w] ? x[A.dataPointIndexes[w]] : { x: w, y: null };
              if (
                !(
                  w < a.axisX.dataInfo.viewPortMin ||
                  (w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca))
                )
              )
                if ("number" !== typeof aa.y) A.connectNullData || (ca || s) || f(), (ca = !0);
                  ...
                  s || ca
                    ? (!s && A.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(n, d),
                          v && D.lineTo(n, d))
                        : (c.beginPath(), c.moveTo(n, d), v && (D.beginPath(), D.moveTo(n, d))),
                      (ca = s = !1))
                    : (c.lineTo(n, d),
                      v && D.lineTo(n, d),
                      0 == p % 250 &&
                        (f(), c.moveTo(n, d), v && D.moveTo(n, d), t.push({ x: n, y: m - wa })));
                  u = { x: n, y: d };
                  p < x.length - 1 &&
                    (L !== (x[p].lineColor || z) || q !== (x[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(n, d),
                    t.push({ x: n, y: m - wa }),
                    ...
                    c.setLineDash &&
                      (x[p].lineDashType
                        ? ((q = x[p].lineDashType), c.setLineDash(F(q, A.lineThickness)))
                  ...
                  0 <= A.dataPointIndexes[w] &&
                    ...
                    ((w = A.getMarkerProperties(A.dataPointIndexes[w], n, d, c)),
                    g.push(w),
                    (markerColor = R(ma)),
                    v &&
                      g.push({
        ...
        for (x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          if (0 < k.length) {
            ...
            for (var ca = !0, p = 0; p < k.length; p++) {
              w = k[p];
              var aa = null,
                aa = 0 <= A.dataPointIndexes[w] ? z[A.dataPointIndexes[w]] : { x: w, y: null };
              if (
                !(
                  w < a.axisX.dataInfo.viewPortMin ||
                  (w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca))
                  ...
                  s || ca
                    ? (!s && A.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(n, d),
                          v && y.lineTo(n, d))
                        : (c.beginPath(), c.moveTo(n, d), v && (y.beginPath(), y.moveTo(n, d))),
                      (ca = s = !1))
                    : (c.lineTo(n, d),
                      v && y.lineTo(n, d),
                      0 == p % 250 &&
                        (f(), c.moveTo(n, d), v && y.moveTo(n, d), t.push({ x: n, y: q - ma })));
                  m = { x: n, y: d };
                  p < z.length - 1 &&
                    (L !== (z[p].lineColor || C) || u !== (z[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(n, d),
                    t.push({ x: n, y: q - ma }),
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ? ((u = z[p].lineDashType), c.setLineDash(F(u, A.lineThickness)))
    ...
    q.prototype.renderBubble = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = -Infinity, t = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
          for (
            var r = a.dataSeriesIndexes[k], p = this.data[r], n = p.dataPoints, d = 0, e = 0;
            e < n.length;
            e++
          )
        ...
        for (
          var w = 25 * Math.PI,
            m = Math.max(Math.pow((0.25 * Math.min(c.height, c.width)) / 2, 2) * Math.PI, w),
            k = 0;
          k < a.dataSeriesIndexes.length;
          k++
        )
              ...
              if (
                ...
                var d = n[e].z,
                  s =
                    2 *
                    Math.max(
                      Math.sqrt((l === t ? m / 2 : w + ((m - w) / (l - t)) * (d - t)) / Math.PI) <<
                        0,
                      1
                    ),
          ...
          if (0 < r.length) {
            ...
            for (var p = 0, n = 0, e = 0; e < r.length; e++)
              if (
                ...
                b.globalAlpha = 1;
                (Math.sqrt((p - g) * (p - g) + (n - h) * (n - h)) < Math.min(d.size, 5) &&
          ...
          if (0 < q.length)
            for (var H = 5 < w && u.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)
              if (
                ...
                !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) &&
                  !y(q[l].y) &&
                  q[l].y.length &&
                ...
                "candlestick" === u.type
                  ? (b.moveTo(t - z, r),
                    ...
                    v &&
                      ...
                      c.lineTo(t - z, p),
                      c.stroke(),
                      X(c, x, Math.min(k, n), B, Math.max(k, n), e, 0, null, !1, !1, !1, !1)))
                  : "ohlc" === u.type &&
                    (b.moveTo(t - z, r),
                    b.lineTo(t - z, p),
                    b.stroke(),
              ...
              if (
                ...
                v &&
                  ...
                  0 < ma &&
                    ...
                    c.lineTo(l - C - E, r),
                    c.stroke()),
                  X(c, B, Math.max(k, r), A, Math.min(k, r), e, 0, null, !1, !1, !1, !1),
                  0 < K &&
                    (c.beginPath(),
                    (c.lineWidth = K),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          var H = a.dataSeriesIndexes[s],
            ...
            A = y(x._linkedSeries)
              ? !1
              : x._linkedSeries.type.match(/(bar|column)/gi) && x._linkedSeries.visible
                ? !0
                : !1,
            C = 0;
          if (A)
          ...
          l = this.options.dataPointMaxWidth
            ...
            : this.options.dataPointWidth
              ? this.dataPointWidth
              : c
                ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (A ? q : 1))) << 0
                : 0.3 * this.width;
          g &&
            (l = this.options.dataPointMaxWidth
              ? this.dataPointMaxWidth
          ...
          if (0 < B.length)
            for (var F = x._colorSet, l = 0; l < B.length; l++) {
              ...
              if (
                ...
                z(b, Math.min(r, p), Math.min(n, d), Math.max(p, r), Math.max(d, n), e, L, K, c);
          ...
          if (0 < p.length) {
            ...
            for (var L = !0; d < p.length; d++)
              if (
                ...
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !L))
                ))
              )
                if (
                  null !== p[d].y &&
                  ...
                  d < p.length - 1 &&
                    (B !== (p[d].lineColor || x) || A !== (p[d].lineDashType || r.lineDashType)) &&
                    (f(),
                    (B = p[d].lineColor || x),
                    ...
                    c.setLineDash &&
                      (p[d].lineDashType
                        ? ((A = p[d].lineDashType),
                          (t[t.length - 1].newLineDashArray = F(A, r.lineThickness)),
            ...
            for (d = !1; p < r.length; p++)
              if (
                ...
                !(
                  ...
                  (n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !d))
                ))
              )
                if (
                  null !== r[p].y &&
                  ...
                  q[q.length] = { x: n, y: w };
                  p < r.length - 1 &&
                    (y !== (r[p].lineColor || s) || z !== (r[p].lineDashType || k.lineDashType)) &&
                    ((y = r[p].lineColor || s),
                    (m[m.length - 1].newStrokeStyle = y),
                    c.setLineDash &&
                      (r[p].lineDashType
                        ? ((z = r[p].lineDashType),
                          (m[m.length - 1].newLineDashArray = F(z, k.lineThickness)))
                        : ((z = k.lineDashType), (m[m.length - 1].newLineDashArray = B))));
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        (0 < m.length &&
                          (k.options.nullDataLineDashType || !r[p - 1].lineDashType)) &&
                        ((m[m.length - 1].newLineDashArray = A), (z = k.nullDataLineDashType))
                      : (f(B, s), (m = []), (q = []))),
                    (d = !0);
            f(B, s);
            $.drawMarkers(g);
    ...
    q.prototype.renderWaterfall = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          h > t &&
          (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, t));
        !this.dataPointMaxWidth &&
          (this.dataPointMinWidth && t < h) &&
          (t = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h));
        n < h && (n = h);
        n > t && (n = t);
        b.save();
        v && this._eventManager.ghostCtx.save();
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          if (0 < q.length)
            for (
              var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, z = null, A = null, h = 0;
              h < q.length;
              h++
            )
              if (
                (q[h].getTime ? (r = q[h].x.getTime()) : (r = q[h].x), "number" !== typeof q[h].y)
              ) {
                ...
                t =
                  0 === m.dataPointEOs[h].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(m.dataPointEOs[h].cumulativeSum);
                k =
                  0 === m.dataPointEOs[h].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(m.dataPointEOs[h].cumulativeSumYStartValue);
                l = a.axisX.reversed
                  ? (l +
                ...
                var L = q[h].color ? q[h].color : 0 < q[h].y ? m.risingColor : m.fallingColor;
                ...
                K =
                  ...
                  ("undefined" !== typeof q[h].isCumulativeSum && !0 === q[h].isCumulativeSum)
                    ? 0 < q[h].y
                      ? t
                      : k
                    : 0 < q[h].y
                ...
                0 < h &&
                  ...
                  0 < u && b.stroke(),
                  v &&
                    (c.beginPath(), c.moveTo(z, A - s), c.lineTo(L, K - s), 0 < u && c.stroke()));
                x = !1;
                z = la;
                A = 0 < q[h].y ? t : k;
                L = q[h].lineDashType
      ...
      function f() {
        if (k && r) {
          for (var a = 0, b = 0, c = 0, e = 0, f = 0; f < r.length; f++) {
            ...
            l.indexLabelMaxWidth = g.indexLabelMaxWidth
              ...
              : k.indexLabelMaxWidth
                ...
                : 0.33 * n.width;
            l.indexLabelWrap =
              "undefined" !== typeof g.indexLabelWrap ? g.indexLabelWrap : k.indexLabelWrap;
            l.startAngle =
              0 === f ? (k.startAngle ? (k.startAngle / 180) * Math.PI : 0) : d[f - 1].endAngle;
          ...
          for (f = 0; f < r.length; f++)
            (l = d[(e + f) % r.length]),
              1 < b &&
                (l.midAngle > (3 * Math.PI) / 2 - u && l.midAngle < (3 * Math.PI) / 2 + u) &&
                (h <= b / 2 && !p
                  ? ((l.hemisphere = "left"), h++)
          ...
          (c = d[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(F(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                a.beginPath(),
                a.moveTo(e, f),
        ...
        if (0 <= a && a < r.length) {
          ...
          0 > b
            ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > h &&
              l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b < h &&
              (b = -(h - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b)))
            : l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 < h &&
              l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b > n &&
              (b = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b - n);
            ...
            ? ((n = "right" === l.hemisphere ? p : t),
              ...
              null !== n &&
                ...
                (b =
                  ...
                  (d[n].indexLabelTextBlock.y + d[n].indexLabelTextBlock.height / 2)),
                b - p < m &&
                  ((h = -p),
                  (n = g(n, h, f + 1)),
                  +n.toFixed(v) > +h.toFixed(v) && (k = b > m ? -(b - m) : -(p - (n - h))))))
            : 0 < b &&
              ...
              null !== n &&
                ...
                b - p < m &&
                  ((h = p),
                  (n = g(n, h, f + 1)),
                  +n.toFixed(v) < +h.toFixed(v) && (k = b > m ? b - m : p - (h - n)))));
          k &&
            ...
            l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u
              ? ((h = (a - 1 + d.length) % d.length),
                ...
                "left" === l.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x
              ...
              : l.midAngle > (3 * Math.PI) / 2 - u &&
                ...
                (h = d[h]),
                (a = d[(a + 1 + d.length) % d.length]),
                "right" === l.hemisphere && "left" === h.hemisphere && b < h.indexLabelTextBlock.x
                  ? (b = h.indexLabelTextBlock.x + 15)
                  : "left" === l.hemisphere &&
        ...
        for (var b = (a = 0), f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                ...
                if (0 > B) {
                  for (var F = (y = 0), sa = 0; sa < r.length; sa++)
                    sa !== a &&
                      ...
                      (d[sa].indexLabelTextBlock.y < l.indexLabelTextBlock.y ? y++ : F++);
                  y = (B / (y + F || 1)) * F;
                  var F = -1 * (B - y),
                    J = (sa = 0);
                  "right" === l.hemisphere
          ...
          for (a = 0; a < r.length; a++)
            if (
              ...
              (z = z = 0),
                "right" === l.hemisphere
                  ? ((z = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + p)),
                    (z *= -1))
                  : (z = n.x1 - (l.indexLabelTextBlock.x - l.indexLabelTextBlock.width - p)),
                0 < z &&
                  (!h &&
                    l.indexLabelText &&
                    ((y =
                ...
                0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI
                  ? ((z = n.y2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + 5)),
                    (z *= -1))
                  : (z = n.y1 - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - 5)),
                0 < z &&
                  (!h &&
                    l.indexLabelText &&
                    ((y = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1),
                    0 === g(a, z * y) && g(a, 2 * y)),
      ...
      function l() {
        ...
        t.legend &&
          (t.legend.dockInsidePlotArea ||
            ("center" === t.legend.horizontalAlign && "center" === t.legend.verticalAlign)) &&
          t.legend.render();
      }
      var t = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== z) {
          ...
          this.pieDoughnutClickHandler = function(a) {
            t.isAnimating ||
              (!y(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick) ||
              ((a = a.dataPoint),
    ...
    q.prototype.renderFunnel = function(a) {
      ...
      function c() {
        if (u && x) {
          for (
            ...
            (m = N[B]),
              (m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2),
              (m = d(m).x2 + 1),
              (w[B] = S - m - U);
          m = 0.5 * U;
          ...
          for (f = 0; f < N.length; f++)
            0 == G[f].textBlock.text.length
              ...
              : ((a = N[f]),
                ...
                (e = G[f].width),
                b >= c
                  ? ((b = f != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2),
                    (c = f != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2),
                    (G[f].textBlock.x = b),
                    (G[f].textBlock.y = c))
                  : (G[f].isDirty = !0));
      }
      ...
      function l(a, b) {
        return (
          ...
          (0 > a ? (u.reversed ? ra - C : T - C) : G[a].textBlock.y + G[a].height + ga)
        );
      }
      function t(a, b, c) {
        var d,
        ...
        for (var b, c, e, f, g = 0; g < N.length; g++)
          (f = 1 === G[g].lineThickness % 2 ? 0.5 : 0),
            ...
            G[g].isDirty ||
              ...
              a.setLineDash && a.setLineDash(F(G[g].lineDashType, G[g].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(e, f),
              a.stroke());
      ...
      function m(a) {
        for (var b = 0; b < N.length; b++)
          G[b].isDirty || (a && (G[b].textBlock.ctx = a), G[b].textBlock.render(!0));
      }
      function q(a) {
        ...
        s.title &&
          (s.title.dockInsidePlotArea ||
            ("center" === s.title.horizontalAlign && "center" === s.title.verticalAlign)) &&
        ...
        s.legend &&
          (s.legend.dockInsidePlotArea ||
            ("center" === s.legend.horizontalAlign && "center" === s.legend.verticalAlign)) &&
        ...
        if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
          ...
          "funnel" === u.type
            ? ((P = y(u.options.neckHeight) ? 0.35 * J : u.neckHeight),
              ...
              P > J ? (P = J) : 0 >= P && (P = 0),
              E > a ? (E = a - 0.5) : 0 >= E && (E = 0))
            : "pyramid" === u.type && ((E = P = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = K + a / 2,
            Y = K,
            X = K + a,
            T = u.reversed ? aa : ca,
          ...
          if (-1 !== K) {
            if (u.reversed) for (I.push(V), E = K.length - 1; 0 < E; E--) (V += K[E]), I.push(V);
            else for (E = 0; E < K.length; E++) (V += K[E]), I.push(V);
            if (u.reversed)
              for (E = 0; E < K.length; E++)
                I[E] < ba
                  ? (a.push(M), B.push(Z), (fa = E))
                  : (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha * X) / ha));
            else
              for (E = 0; E < K.length; E++)
                I[E] < ba
                  ? (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha * X) / ha), (fa = E))
                  : (a.push(M), B.push(Z));
            ...
            for (E = 0; E < x.length; E++)
              x[E].exploded && ((K = !0), u.reversed ? $.push(x.length - 1 - E) : $.push(E));
            ...
            this.funnelPyramidClickHandler = function(a) {
              ...
              if (
                ...
                if ("funnel" === u.type || "pyramid" === u.type)
                  u.reversed
                    ? (x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0)
      ...
      if (0 <= a.type.indexOf("stacked"))
        (c = 0),
          ...
          b in a.plotUnit.yTotals &&
            ((c = a.plotUnit.yTotals[b]), (e = isNaN(f.y) ? 0 : 100 * (f.y / c)));
      else if (
        "pie" === a.type ||
        "doughnut" === a.type ||
        "funnel" === a.type ||
    ...
    q.prototype.replaceKeywordsWithValue = function(a, f, b, c, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace(
            "#total",
            V(l, b.yValueFormatString ? b.yValueFormatString : "#,##0.########", g._cultureInfo)
          );
    ...
    T.prototype.render = function() {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        h = 0,
        l = (this.markerMargin =
          this.chart.options.legend && !y(this.chart.options.legend.markerMargin)
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ((this.orientation = "horizontal"),
          ...
          (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : f.width),
          (h = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * f.height))
        : "center" === this.verticalAlign &&
          ((this.orientation = "vertical"),
          (b = this.horizontalAlign),
          (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * f.width),
          (h = this.maxHeight = null !== this.maxHeight ? this.maxHeight : f.height));
              ...
              q = (n.legendMarkerColor = n.legendMarkerColor
                ...
                : n.markerColor
                  ...
                  : "error" === n.type
                    ...
                    : n._colorSet[0]),
              s =
                n.markerSize || ("line" !== n.type && "stepLine" !== n.type && "spline" !== n.type)
          ...
          if (!(0 >= h || "undefined" === typeof h || 0 >= q || "undefined" === typeof q)) {
            ...
            n.width += Math.round(
              d.textBlock.width +
                ...
                l +
                (0 === n.width ? 0 : this.horizontalSpacing) +
                ("line" === d.chartType || "spline" === d.chartType || "stepLine" === d.chartType
                  ? 2 * 0.1 * this.lineHeight
                  : 0)
            );
            n.items.push(d);
        ...
        for (z = x = 0; z < n.items.length; z++) {
          ...
          if ("line" === d.chartType || "stepLine" === d.chartType || "spline" === d.chartType)
            (this.ctx.strokeStyle = d.lineColor),
              ...
              this.ctx.beginPath(),
              this.ctx.moveTo(q - 0.1 * this.lineHeight, u + this.lineHeight / 2),
              this.ctx.lineTo(q + 0.85 * this.lineHeight, u + this.lineHeight / 2),
              this.ctx.stroke(),
          ...
          $.drawMarker(
            ...
            this.ctx,
            d.markerType,
            "error" === d.chartType || "line" === d.chartType || "spline" === d.chartType
              ? d.markerSize / 2
              : d.markerSize,
            d.markerColor,
            d.markerBorderColor,
          ...
          var n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            p =
              1 < n
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / n) * Math.log(p / this.dataPoints[0].x)) >>
                        0,
                      0
                    ),
                    this.dataPoints.length
          ...
          (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (p =
              0 < n
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / n) * (p - this.dataPoints[0].x)) >> 0,
                      0
                    ),
                    this.dataPoints.length
                  )
          ...
          if (n) {
            switch (this.type) {
              ...
              case "scatter":
                ...
                m <= s &&
                  c.push({ dataPoint: d, dataPointIndex: g, dataSeries: this, distance: m });
                n = Math.abs(n.x1 - a);
                n <= t ? (t = n) : 0 < h ? k++ : r++;
                m <= q / 2 && (l = !0);
                break;
              ...
              case "doughnut":
                ...
                m < n.radius &&
                  ...
                  0 > m && (m += 2 * Math.PI),
                  (m = Number(((((180 * (m / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  (q = Number(
                    ((((180 * (n.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12)
                  )),
                  (s = Number(((((180 * (n.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
              ...
              case "pyramid":
                ...
                f > m.y1 &&
                  ...
                  (m.y6
                    ? f > m.y6
                      ? ((g = m.x6 + ((m.x5 - m.x6) / (m.y5 - m.y6)) * (f - m.y6)),
                        (m = m.x3 + ((m.x4 - m.x3) / (m.y4 - m.y3)) * (f - m.y3)))
                      : ((g = m.x1 + ((m.x6 - m.x1) / (m.y6 - m.y1)) * (f - m.y1)),
                        (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (f - m.y2)))
                    : ((g = m.x1 + ((m.x4 - m.x1) / (m.y4 - m.y1)) * (f - m.y1)),
                      (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (f - m.y2))),
                  a > g &&
                    a < m &&
                    (c.push({
              ...
              case "boxAndWhisker":
                if (
                  ...
                  (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && f >= n.y1 && f <= n.y4)
                )
                  c.push({
                    dataPoint: d,
                    dataPointIndex: g,
              ...
              case "ohlc":
                if (
                  (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && f >= n.y2 && f <= n.y3) ||
                  (a >= n.x1 &&
                    a <= (n.x2 + n.x1) / 2 &&
                    f >= n.y1 - n.borderThickness / 2 &&
                    f <= n.y1 + n.borderThickness / 2) ||
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        for (
          this.intervalStartPosition = this.getLabelStartPoint(
            ...
            e = Ta(new Date(this.viewportMaximum), this.interval, this.intervalType),
            d = n,
            b = this.intervalStartPosition;
          b < e;
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                if (
                  ...
                  if (
                    ...
                    (m =
                      (k - (t + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) /
                      Math.sin((Math.PI / 180) * Math.abs(-25))),
                    !y(this.options.labelWrap))
                  )
                    this.labelWrap
                      ? y(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), m)),
                          (this.sessionVariables.labelWrap = this.labelWrap),
                    ...
                    if (y(this.options.labelWrap))
                      if (!y(this.options.labelMaxWidth))
                        ...
                        if (((c = (q.width + f.width) >> 0), (d = this.labelFontSize), n < g))
                            ...
                            c >= 2 * g && c < 2.2 * g
                              ? ((this.sessionVariables.labelMaxWidth = g),
                                y(this.options.labelFontSize) &&
                                  12 < d &&
                                  ((d = Math.floor((12 / 13) * d)), a.measureText()),
                                (this.sessionVariables.labelFontSize = y(this.options.labelFontSize)
                                  ? d
                          ...
                          s === b &&
                          ((0 === s &&
                            n + this._labels[s + 1].textBlock.measureText().width - 2 * g > p) ||
                          ...
                          (p =
                            0 === s
                              ? n + this._labels[s + 1].textBlock.measureText().width - 2 * g
                              : n + this._labels[s - 1].textBlock.measureText().width - 2 * g),
                            (this.sessionVariables.labelFontSize = y(this.options.labelFontSize)
                              ? d
                              : this.options.labelFontSize),
          ...
          if (
            ...
            this.sessionVariables.labelMaxWidth = g;
            this.sessionVariables.labelMaxHeight = h;
            this.sessionVariables.labelAngle = y(this.sessionVariables.labelAngle)
              ? 0
              : this.sessionVariables.labelAngle;
            this.sessionVariables.labelWrap = this.labelWrap;
            for (b = 0; b < this._labels.length; b++)
        ...
        for (f = 0; f < this._labels.length; f++) {
          var b = this._labels[f].textBlock,
            ...
            e =
              0 === this.labelAngle
                ? c.width
                : c.width * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)) +
        ...
        for (b = 0; b < this._labels.length; b++) {
          ...
          var c = f.measureText(),
            ...
            e =
              0 === this.labelAngle
                ? c.height
                : c.width * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)) +
        ...
        if (n[d] && n[d].scaleBreaks && n[d].scaleBreaks._appliedBreaks.length)
          for (
            ...
            q[s].endValue < n[d].viewportMinimum ||
              (y(n[d].scaleBreaks.firstBreakIndex) && (n[d].scaleBreaks.firstBreakIndex = s),
              q[s].startValue >= n[d].viewPortMinimum && (n[d].scaleBreaks.lastBreakIndex = s));
      for (
        var x = (s = 0),
          u = 0,
          z = 0,
        ...
        for (var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = []; 4 > s; ) {
          ...
          if (b && 0 < b.length)
            for (F = [], d = N = 0; d < b.length; d++)
              F.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateWidth() : 0)),
                (N += F[d]),
                (M += b[d] ? b[d].margin : 0);
          ...
          if (c && 0 < c.length)
            for (B = [], d = ba = 0; d < c.length; d++)
              B.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateWidth() : 0)),
                (ba += B[d]),
                ($ += c[d] ? c[d].margin : 0);
              ...
              a[d] && (a[d].lineCoordinates = {}),
                ...
                a[d].title &&
                  (a[d]._titleTextBlock.maxWidth =
                    0 < a[d].titleMaxWidth && a[d].titleMaxWidth < a[d].lineCoordinates.width
                      ? a[d].titleMaxWidth
                      : a[d].lineCoordinates.width),
                z.push(Math.ceil(a[d] ? a[d].createLabelsAndCalculateHeight() : 0)),
                (Z += z[d]),
                (e += a[d] ? a[d].margin : 0);
              ...
              f[d] && (f[d].lineCoordinates = {}),
                ...
                f[d].title &&
                  (f[d]._titleTextBlock.maxWidth =
                    0 < f[d].titleMaxWidth && f[d].titleMaxWidth < f[d].lineCoordinates.width
                      ? f[d].titleMaxWidth
                      : f[d].lineCoordinates.width),
                C.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateHeight() : 0)),
                (V += C[d]),
                (W += f[d] ? f[d].margin : 0);
            ...
            for (d = 0; d < a.length; d++)
              a[d] &&
                ...
                a[d] &&
                  ...
                  ((l = 0),
                  0 < a[d].labelAngle
                    ? I + u > t && (l += 0 < a[d].labelAngle ? I + u - t - ba : 0)
                    : 0 > a[d].labelAngle
                      ? A - x < h &&
                        A - x < a[d].viewportMinimum &&
                        (J = h - (M + a[d].tickLength + F + A - x + a[d].labelFontSize / 2))
                      : 0 === a[d].labelAngle &&
                        (I + u > t && (l = I + u / 2 - t - ba),
                        A - x < h &&
                          A - x < a[d].viewportMinimum &&
          ...
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (M = 10),
                b[d] &&
                  ((h = Math.round(a[0] ? a[0].lineCoordinates.x1 : f[0].lineCoordinates.x1)),
                  (M =
                    b[d]._labels && 0 < b[d]._labels.length
                      ? b[d]._labels[b[d]._labels.length - 1].textBlock.height / 2
                      : 10),
                  (l = Math.round(g.y1 + V + W < Math.max(M, 10) ? Math.max(M, 10) : g.y1 + V + W)),
                  (t = Math.round(a[0] ? a[0].lineCoordinates.x1 : f[0].lineCoordinates.x1)),
                  (M =
                    0 < a.length
                      ? 0
                      : b[d]._labels && 0 < b[d]._labels.length
                  ...
                  b[d].title &&
                    (b[d]._titleTextBlock.maxWidth =
                      0 < b[d].titleMaxWidth && b[d].titleMaxWidth < b[d].lineCoordinates.height
                        ? b[d].titleMaxWidth
          ...
          if (c && 0 < c.length)
            for (d = 0; d < c.length; d++)
              c[d] &&
                ((h = Math.round(a[0] ? a[0].lineCoordinates.x2 : f[0].lineCoordinates.x2)),
                (t = Math.round(h)),
                (M =
                ...
                c[d].title &&
                  (c[d]._titleTextBlock.maxWidth =
                    0 < c[d].titleMaxWidth && c[d].titleMaxWidth < c[d].lineCoordinates.height
                      ? c[d].titleMaxWidth
            ...
            for (d = 0; d < a.length; d++)
              a[d] &&
                ...
                a[d]._labels &&
                  ...
                  ((A =
                    (a[d].logarithmic
                      ? Math.log(a[d]._labels[1].position / a[d].viewportMinimum) /
                  ...
                  (h =
                    a[d]._labels[a[d]._labels.length - ("dateTime" === a[d].valueType ? 2 : 1)]
                      .position),
                  (h = a[d].getApparentDifference(a[d].viewportMinimum, h)),
                  (I = a[d].logarithmic
                    ? (1 < h
                        ? (Math.log(h) / a[d].conversionParameters.lnLogarithmBase) *
                          Math.abs(a[d].conversionParameters.pixelPerUnit)
                        : 0) + a[d].lineCoordinates.x1
                    : (0 < h ? h * Math.abs(a[d].conversionParameters.pixelPerUnit) : 0) +
                      a[d].lineCoordinates.x1)));
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++)
              f[d].calculateValueToPixelConversionParameters(),
                ...
                f[d]._labels &&
                  ...
                  ((A =
                    (f[d].logarithmic
                      ? Math.log(f[d]._labels[1].position / f[d].viewportMinimum) /
                  ...
                  (h =
                    f[d]._labels[f[d]._labels.length - ("dateTime" === f[d].valueType ? 2 : 1)]
                      .position),
                  (h = f[d].getApparentDifference(f[d].viewportMinimum, h)),
                  (I = f[d].logarithmic
                    ? (1 < h
                        ? (Math.log(h) / f[d].conversionParameters.lnLogarithmBase) *
                          Math.abs(f[d].conversionParameters.pixelPerUnit)
                        : 0) + f[d].lineCoordinates.x1
                    : (0 < h ? h * Math.abs(f[d].conversionParameters.pixelPerUnit) : 0) +
                      f[d].lineCoordinates.x1));
          for (d = 0; d < n.length; d++)
            "axisY" === n[d].type &&
        ...
        for (S = []; 4 > s; ) {
          ...
          if (a && 0 < a.length)
            for (x = [], d = Z = 0; d < a.length; d++)
              x.push(Math.ceil(a[d] ? a[d].createLabelsAndCalculateWidth() : 0)),
                (Z += x[d]),
                (e += a[d] ? a[d].margin : 0);
          ...
          if (f && 0 < f.length)
            for (I = [], d = V = 0; d < f.length; d++)
              I.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)),
                (V += I[d]),
                (W += f[d] ? f[d].margin : 0);
          ...
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                ...
                (t = Math.round(g.x2 - V - W > m.width - 10 ? m.width - 10 : g.x2 - V - W)),
                b[d].labelAutoFit &&
                  !y(z) &&
                  (0 < !a.length &&
                    (h =
                      0 > b[d].labelAngle
                        ...
                        : 0 === b[d].labelAngle
                          ...
                          : h),
                  0 < !f.length &&
                    (t = 0 < b[d].labelAngle ? t - C / 2 : 0 === b[d].labelAngle ? t - C / 2 : t)),
                (b[d].lineCoordinates.x1 = h),
                (b[d].lineCoordinates.x2 = t),
                (b[d].lineCoordinates.width = Math.abs(t - h)),
                b[d].title &&
                  (b[d]._titleTextBlock.maxWidth =
                    0 < b[d].titleMaxWidth && b[d].titleMaxWidth < b[d].lineCoordinates.width
                      ? b[d].titleMaxWidth
          ...
          if (c && 0 < c.length)
            for (d = 0; d < c.length; d++)
              (c[d].lineCoordinates = {}),
                (h = Math.round(g.x1 + Z + e)),
                (t = Math.round(
                  g.x2 - V - W > c[d].chart.width - 10 ? c[d].chart.width - 10 : g.x2 - V - W
                )),
                c[d] &&
                  c[d].labelAutoFit &&
                  !y(F) &&
                ...
                c[d].title &&
                  (c[d]._titleTextBlock.maxWidth =
                    0 < c[d].titleMaxWidth && c[d].titleMaxWidth < c[d].lineCoordinates.width
                      ? c[d].titleMaxWidth
                      : c[d].lineCoordinates.width);
          if (b && 0 < b.length)
            for (A = [], d = X = 0; d < b.length; d++)
              A.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateHeight() : 0)),
                (X += A[d] + b[d].margin),
                (M += b[d].margin);
          ...
          if (c && 0 < c.length)
            for (J = [], d = N = 0; d < c.length; d++)
              J.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateHeight() : 0)),
                (N += J[d]),
                ($ += c[d].margin);
          ...
          if (b && 0 < b.length)
            for (d = b.length - 1; 0 <= d; d--)
              (l = Math.round(g.y2)),
                (k = Math.round(g.y2 > b[d].chart.height - 10 ? b[d].chart.height - 10 : g.y2)),
          ...
          if (a && 0 < a.length)
            for (d = 0; d < a.length; d++) {
                    ...
                    ((t =
                      0 > b[M].labelAngle
                        ...
                        : 0 === b[M].labelAngle
                          ? Math.max(t, z / 2)
                          : t),
                    (h = 0 > b[M].labelAngle || 0 === b[M].labelAngle ? t - Z : h));
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] && c[M].labelAutoFit && ((t = c[M].lineCoordinates.x1), (h = t - Z));
              a[d].lineCoordinates = {
                x1: t - T,
                y1: l,
                x2: t - T,
              ...
              a[d].title &&
                (a[d]._titleTextBlock.maxWidth =
                  0 < a[d].titleMaxWidth && a[d].titleMaxWidth < a[d].lineCoordinates.height
                    ? a[d].titleMaxWidth
          ...
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++) {
                    ...
                    ((t =
                      0 > b[M].labelAngle
                        ...
                        : 0 === b[M].labelAngle
                          ? Math.max(t, z / 2)
                          : t),
                    (h = 0 > b[M].labelAngle || 0 === b[M].labelAngle ? t - V : h));
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] && c[M].labelAutoFit && ((t = c[M].lineCoordinates.x2), (h = t - V));
              f[d].lineCoordinates = {
                x1: t + Y,
                y1: l,
                x2: t + Y,
              ...
              f[d].title &&
                (f[d]._titleTextBlock.maxWidth =
                  0 < f[d].titleMaxWidth && f[d].titleMaxWidth < f[d].lineCoordinates.height
                    ? f[d].titleMaxWidth
        ...
        if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
          ...
          this.stripLines[a].value = this.logarithmic
            ? this.stripLines[a].value *
              Math.sqrt(
                Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(f)
              )
            : this.stripLines[a].value +
              (Math.abs(this.stripLines[a].endValue - this.stripLines[a].startValue) - f) / 2;
    ...
    C.prototype.calculateBreaksSizeInValues = function() {
      for (
        ...
        (e = c || !y(f[g].options.spacing)),
          (f[g].spacing = J(f[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
          (f[g].size = 0 > f[g].spacing ? 0 : Math.abs(f[g].spacing / b)),
          this.logarithmic && (f[g].size = Math.pow(this.logarithmBase, f[g].size));
    };
      ...
      if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
        ...
        for (var f = 0; f < a.length && !(a[f].startValue > this.conversionParameters.maximum); f++)
          a[f].endValue < this.conversionParameters.minimum ||
            (y(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = f),
    ...
    C.prototype.renderLabelsTicksAndTitle = function() {
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              ...
              p.position > this.viewportMaximum ||
                !(k === this._labels.length - 1 || h < (Math.log(l / p.position) * m) / e) ||
                (b.push(p),
                (l = p.position),
                (h =
        ...
        if ("left" === this._position || "right" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              ...
              if (p.position < this.viewportMinimum) break;
              p.position > this.viewportMaximum ||
                !(k === this._labels.length - 1 || r < Math.log(l / p.position) * m) ||
                (b.push(p),
                (l = p.position),
                (r =
      ...
      if ("bottom" === this._position) {
        for (k = 0; k < this._labels.length; k++)
          (p = this._labels[k]),
            p.position < this.viewportMinimum ||
              (p.position > this.viewportMaximum || (f && 0 !== g++ % 2 && this.labelAutoFit)) ||
              ...
              0 === p.textBlock.angle
                ...
                : ((n.x =
                    "inside" === this.labelPlacement
                      ? 0 > this.labelAngle
                        ? n.x
                        : n.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                      : n.x -
                        (0 > this.labelAngle
                ...
                ? ((n.x -= p.textBlock.width / 2),
                  (n.y =
                    "inside" === this.labelPlacement
                      ...
                      : n.y - (this.tickLength + p.textBlock.height - p.textBlock.fontSize / 2)))
                : ((n.x =
                    "inside" === this.labelPlacement
                      ? 0 < this.labelAngle
                        ? n.x
                        : n.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                      : n.x +
                        (p.textBlock.height - this.tickLength - this.labelFontSize) *
            ...
            p.position < this.viewportMinimum ||
              ...
              0 === this.labelAngle
                ...
                : ((p.textBlock.y =
                    "inside" === this.labelPlacement
                      ? n.y
                      : n.y - p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                  (p.textBlock.x =
                    "inside" === this.labelPlacement
                      ? n.x + this.tickLength + 5
                      : 0 < this.labelAngle
        ...
        for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)
          f
            ? ((f = this.getPixelCoordinatesOnAxis(this._labels[e].position)),
              ...
              a.fillRect(Math.min(b.x, f.x), c.y1, Math.abs(b.x - f.x), Math.abs(c.y1 - c.y2)),
              (f = !1))
            : (f = !0);
            ...
            ? ((b = this.getPixelCoordinatesOnAxis(this._labels[e].position)),
              (f =
                e + 1 > this._labels.length - 1
                  ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                  : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position)),
              a.fillRect(c.x1, Math.min(b.y, f.y), Math.abs(c.x1 - c.x2), Math.abs(f.y - b.y)),
              (f = !1))
            : (f = !0);
      a.beginPath();
    };
    C.prototype.renderStripLinesOfThicknessType = function(a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var f = this, b, c = 0, e = 0, g = !1, h = !1, l = [], m = [], h = !1, c = 0;
          ...
          if (
            ...
            if ("outside" === b.stripLine.labelPlacement)
              if (
                ...
                "top" === this._position
                  ? ((r = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
                    this.ctx.beginPath(),
                    this.ctx.moveTo(r, a.y << 0),
                    this.ctx.lineTo(r, (a.y - this.tickLength) << 0),
                    this.ctx.stroke(),
                        ...
                        (a.y -=
                          ...
                          (b.textBlock.height * Math.cos((Math.PI / 180) * this.labelAngle) +
                            (0 < this.labelAngle
                              ...
                              : 0)))))
                  : "left" === this._position
                    ? ((r = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
                      this.ctx.beginPath(),
          ...
          if (this.scaleBreaks && !y(this.scaleBreaks.firstBreakIndex))
            if (y(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                ...
                f.moveTo(e, h),
                  f.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + b, h),
              ...
              : a >= e[g].startValue && f >= e[g].endValue
                ...
                : a <= e[g].startValue && f <= e[g].endValue
                  ? (b =
                      ...
                      Math.pow(
                        e[g].size,
                        Math.log(f / e[g].startValue) / Math.log(e[g].endValue / e[g].startValue)
                      ))
                  : !c &&
                    (a > e[g].startValue && f < e[g].endValue) &&
                    (b =
              ...
              : a > e[g].startValue && f >= e[g].endValue
                ...
                : a <= e[g].startValue && f < e[g].endValue
                  ? (b =
                      ...
                      f +
                      e[g].startValue +
                      (e[g].size * (f - e[g].startValue)) / (e[g].endValue - e[g].startValue))
                  : !c &&
                    (a > e[g].startValue && f < e[g].endValue) &&
                    (b = a + (e[g].size * (f - a)) / (e[g].endValue - e[g].startValue)));
      return b;
    };
      ...
      if ("bottom" === this._position || "top" === this._position)
        this.logarithmic
          ? ((f.lnLogarithmBase = Math.log(this.logarithmBase)),
            (f.pixelPerUnit =
              ((this.reversed ? -1 : 1) * b * f.lnLogarithmBase) / Math.log(Math.abs(c))))
          : (f.pixelPerUnit = ((this.reversed ? -1 : 1) * b) / Math.abs(c)),
          (f.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1);
      if ("left" === this._position || "right" === this._position)
        this.logarithmic
          ? ((f.lnLogarithmBase = Math.log(this.logarithmBase)),
            (f.pixelPerUnit =
              ((this.reversed ? 1 : -1) * b * f.lnLogarithmBase) / Math.log(Math.abs(c))))
          : (f.pixelPerUnit = ((this.reversed ? 1 : -1) * b) / Math.abs(c)),
          (f.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2);
                                          ...
                                          : c / (10 * U.secondDuration) <= a
                                            ...
                                            : c / (15 * U.secondDuration) <= a
                                              ...
                                              : c / (20 * U.secondDuration) <= a
                                                ? ((this.interval = 20),
                                                  (this.intervalType = "second"))
                                                : c / (30 * U.secondDuration) <= a
                                                  ? ((this.interval = 30),
                                                    (this.intervalType = "second"))
                                                  : c / (1 * U.minuteDuration) <= a
                                                    ? ((this.interval = 1),
                                                      (this.intervalType = "minute"))
                                                    : c / (2 * U.minuteDuration) <= a
                                                      ? ((this.interval = 2),
                                                        (this.intervalType = "minute"))
                                                      : c / (5 * U.minuteDuration) <= a
                                                        ? ((this.interval = 5),
                                                          (this.intervalType = "minute"))
                                                        : c / (10 * U.minuteDuration) <= a
                                                          ? ((this.interval = 10),
                                                            (this.intervalType = "minute"))
                                                          : c / (15 * U.minuteDuration) <= a
                                                            ? ((this.interval = 15),
                                                              (this.intervalType = "minute"))
                                                            : c / (20 * U.minuteDuration) <= a
                                                              ? ((this.interval = 20),
                                                                (this.intervalType = "minute"))
                                                              : c / (30 * U.minuteDuration) <= a
                                                                ? ((this.interval = 30),
                                                                  (this.intervalType = "minute"))
                                                                : c / (1 * U.hourDuration) <= a
                                                                  ? ((this.interval = 1),
                                                                    (this.intervalType = "hour"))
                                                                  : c / (2 * U.hourDuration) <= a
                                                                    ? ((this.interval = 2),
                                                                      (this.intervalType = "hour"))
                                                                    : c / (3 * U.hourDuration) <= a
                                                                      ? ((this.interval = 3),
                                                                        (this.intervalType =
                                                                          "hour"))
                                                                      : c / (6 * U.hourDuration) <=
    ...
    C.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          "undefined" === typeof this.options.interval &&
          ((this.interval = C.getNiceExponent(Math.ceil(Math.log(h) / f) / (a - 1))),
          (b = C.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        "axisX" === this.type
      ...
      c = Math.pow(
        this.logarithmBase,
        Math.floor(Math.log(this.viewportMinimum) / (f * this.interval) + 0.2) * this.interval
      );
      this.range = this.viewportMaximum / this.viewportMinimum;
      this.noTicks = a;
      if (
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ? ((c = this.chart.plotArea.x1), (h = (this.chart.plotArea.x2 + p / 2 + 0.5) << 0))
    ...
    fa.prototype.createUserOptions = function(a) {
      if ("undefined" !== typeof a || this.options._isPlaceholder) {
        ...
        this.parent.options._isPlaceholder && this.parent.createUserOptions();
        this.options._isPlaceholder ||
          (Ca(this.parent.stripLines), (f = this.parent.options.stripLines.indexOf(this.options)));
        this.options = "undefined" === typeof a ? {} : a;
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var q = 0; q < this.parent.dataSeries.length; q++)
            (d = this.parent.dataSeries[q].getDataPointAtX(n, !0)) &&
              0 <= d.index &&
              ((d.dataSeries = this.parent.dataSeries[q]), null !== d.dataPoint.y && h.push(d));
          d = null;
          ...
          if ("rangeBar" === h[0].dataSeries.type || "error" === h[0].dataSeries.type)
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])),
                s = 0,
                n = 0;
              n < h.length;
              n++
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                for (m = 0; m < h[n].dataPoint.y.length; m++)
                  (s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m]))),
                    s < d && ((d = s), (q = n));
              else
                (s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y))),
                  s < d && ((d = s), (q = n));
          else if ("stackedBar" === h[0].dataSeries.type)
            for (
              var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)),
                v = (s = 0),
                n = (q = 0);
              n < h.length;
              n++
            ...
            for (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (v += h[n].dataPoint.y),
                  (u = h[n].dataPoint.x.getTime ? h[n].dataPoint.x.getTime() : h[n].dataPoint.x),
                  (u = 100 * (v / h[n].dataSeries.plotUnit.dataPointYSums[u])),
                  (s = Math.abs(a - this.parent.convertValueToPixel(u))),
                  s < d && ((d = s), (q = n));
          else
            for (
              d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = q = s = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if (
              ...
              for (n = s = 0; n < m.dataPoint.y.length; n++)
                (s = Math.abs(a - this.parent.convertValueToPixel(m.dataPoint.y[n]))),
                  s < d && ((d = s), (b = n));
              h =
                1 === r.lineWidth % 2
              ...
              l.text = this.labelFormatter
                ...
                : y(this.options.label)
                  ? V(m.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
              ...
              l.text = this.labelFormatter
                ...
                : y(this.options.label)
                  ? V(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
            ...
            if (u) {
              if ("axisX" === this.parent.type)
                for (
                  n = this.parent.convertPixelToValue({ y: f }), d = null, q = 0;
              ...
              "dateTime" === this.parent.valueType
                ? (l.text = this.labelFormatter
                    ...
                    : y(this.options.label)
                      ? Aa(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                      : this.label)
                : "number" === this.parent.valueType &&
                  (l.text = this.labelFormatter
                    ...
                    : y(this.options.label)
                      ? V(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                      : this.label);
          ...
          if (
            ...
            for (
              d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y[0])), n = s = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y))),
                  s < d && ((d = s), (q = n));
          else if (
            ...
            for (
              d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = v = s = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
            ...
            for (
              d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = s = 0;
              n < h.length;
              n++
            )
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
          ...
          if (
            ...
            for (n = s = 0; n < m.dataPoint.y.length; n++)
              (s = Math.abs(f - this.parent.convertValueToPixel(m.dataPoint.y[n]))),
                s < d && ((d = s), (b = n));
            h =
              1 === r.lineWidth % 2
                ? (this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0) + 0.5
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var h = this.chart.axisX[m].convertPixelToValue({ y: f }), k = null, c = 0;
                  c < this.chart.axisX[m].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX[m].dataSeries[c].getDataPointAtX(h, b)) &&
                    0 <= k.index &&
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++) {
                ...
                for (c = 0; c < this.chart.axisX2[m].dataSeries.length; c++)
                  (k = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(h, b)) &&
                    0 <= k.index &&
            ...
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (
                  h = this.chart.axisX[m].convertPixelToValue({ x: a }), k = null, c = 0;
                  c < this.chart.axisX[m].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX[m].dataSeries[c].getDataPointAtX(h, b)) &&
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++)
                for (
                  h = this.chart.axisX2[m].convertPixelToValue({ x: a }), k = null, c = 0;
                ...
                if (0 < k.dataPoint.y.length) {
                  for (c = b = 0; c < k.dataPoint.y.length; c++)
                    k.dataPoint.y[c] < k.dataSeries.axisY.viewportMinimum
                      ? b--
                      : k.dataPoint.y[c] > k.dataSeries.axisY.viewportMaximum && b++;
                    ...
                    : "bubble" === e.type
                      ? ((b = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2),
                        k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - b &&
                          k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + b &&
                          g.push(k))
                      : "waterfall" === e.type
                        ? ((b = 0),
                          k.cumulativeSumYStartValue < k.dataSeries.axisY.viewportMinimum
                            ? b--
                            : k.cumulativeSumYStartValue > k.dataSeries.axisY.viewportMaximum &&
                              b++,
                          k.cumulativeSum < k.dataSeries.axisY.viewportMinimum
                            ? b--
                            : k.cumulativeSum > k.dataSeries.axisY.viewportMaximum && b++,
                          2 > b && -2 < b && g.push(k))
          ...
          if (((b = ""), (b = this.getToolTipInnerHTML({ entries: g })), null !== b)) {
            ...
            try {
              (this.contentDiv.style.background = this.backgroundColor
                ...
                (this.contentDiv.style.color = this.fontColor ? this.fontColor : "transparent"),
            ...
            "rangeSplineArea" === c.type
              ...
              : "bubble" === c.type
                ...
                : "column" === c.type ||
                  ...
                  "rangeColumn" === c.type ||
                  "waterfall" === c.type
                  ? X(f, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3)
    ...
    var O = {
        ...
        xClipAnimation: function(a, f) {
          if (0 !== a) {
            ...
            b.save();
            0 < a &&
              b.drawImage(c, 0, 0, c.width * a, c.height, 0, 0, (c.width * a) / ia, c.height / ia);
            b.restore();
          }
        },
      ...
      $ = {
        drawMarker: function(a, f, b, c, e, g, h, l) {
          if (b) {
            var m = 1;
            b.fillStyle = g ? g : "transparent";
            b.strokeStyle = h ? h : "transparent";
            b.lineWidth = l ? l : 0;
